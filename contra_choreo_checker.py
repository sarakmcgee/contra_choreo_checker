...
def build_figure_dict() -> None:
    ...
    figure_dict['allemande_left'] = Figure(
        "Allemande Left", 8, 0, figure_descriptions["allemande"], [], "partners", "left")
    figure_dict['allemande_right'] = Figure(
        "Allemande Right", 8, 0, figure_descriptions["allemande"], [], "partners", "right")
    figure_dict['balance'] = Figure(
        "Balance", 4, 0, figure_descriptions["balance"], [], "partners")
    figure_dict['box_the_gnat'] = Figure(
        "Box the Gnat", 4, "swap", figure_descriptions["box_the_gnat"], ["box gnat"], "partners")
    figure_dict['cali_twirl'] = Figure("California Twirl", 4, "swap", figure_descriptions["cali_twirl"], [
                                       "cali twirl", "ca twirl"], "partners")
    figure_dict['circle_left'] = Figure(
        "Circle Left", 4, 0, figure_descriptions["circle"], ["circle"], "all", "left")
    figure_dict['do_si_do'] = Figure(
        "Do-si-do", 8, 0, figure_descriptions["do_si_do"], ["do si do", "dosido"], "partners")
    figure_dict['eye_turn'] = Figure("Eye Turn", 8, 0, figure_descriptions["eye_turn"], [
                                     "gypsy", "right shoulder round"], "partners")
    figure_dict['half_hey'] = Figure(
        "Half Hey", 8, "c_swap", figure_descriptions["half_hey"], ["hey across"], "all")
    figure_dict['full_hey'] = Figure(
        "Hey for Four/Full Hey", 16, 0, figure_descriptions["full_hey"], ["hey for four", "full hey"], "all")
    figure_dict['chain'] = Figure("Raven's Chain", 8, "swap", figure_descriptions["chain"], [
                                  "chain", "ladies chain", "ladies' chain", "ravens chain"], "ravens")
    figure_dict['long_lines'] = Figure(
        "Long Lines, Forward and Back", 8, 0, figure_descriptions["long_lines"], ["long lines"], "all")
    figure_dict['mad_robin'] = Figure(
        "Mad Robin", 8, 0, figure_descriptions["mad_robin"], ["sashay round"], "all")
    figure_dict['pass_through'] = Figure(
        "Pass Through", 8, "swap", figure_descriptions["pass_through"], [], "partners")
    figure_dict['petronella'] = Figure(
        "Petronella", 8, "c_swap", figure_descriptions["petronella"], [], "all")
    ...
    figure_dict['promenade'] = Figure(
        "Promenade", 8, "c_swap", figure_descriptions["promenade"], [], "partners")
    figure_dict['pull_by'] = Figure(
        "Pull By", 4, "swap", figure_descriptions["pull_by"], [], "partners")
    figure_dict['right_left_through'] = Figure("Right and Left Through", 8, "c_swap", figure_descriptions["right_left_through"], [
                                               "right and left", "right left through", "right left"], "all")
    figure_dict['star_left'] = Figure("Left Hand Star", 8, 0, figure_descriptions["star"], [
                                      "star by the left", "star left"], "all", "left")
    figure_dict['star_right'] = Figure("Right Hand Star", 8, 0, figure_descriptions["star"], [
                                       "star by the right", "star right"], "all", "right")
    figure_dict['swing'] = Figure(
        "Swing", 8, 0, figure_descriptions["swing"], [], "partners")
...
def check_phrase() -> None:
    ...
    """
    if curr_dance.get_time_remaining() == 0 and curr_dance.get_phrase_counter() < 4:
